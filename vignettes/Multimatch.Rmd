...
We will simulate 80,000 pairs of randomy generated scanpaths and show the distribution of the similarity scores for each metric.
...
plot_height <- 8 # Adjust height as needed
...
high_plots <- wrap_plots(
  ...
  plots[[5]]$high_plot,
  nrow = 5
) + plot_layout(guides = 'collect', heights = rep(plot_height, 5)) + ggtitle("High MultiMatch Scores")
